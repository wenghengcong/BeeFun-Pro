...
struct ScreenSize {
    ...
    static let screen1_32Inch    = UIScreen.isEqual(UIScreen.Size.screen1_32Inch)
    static let screen1_5Inch    = UIScreen.isEqual(UIScreen.Size.screen1_5Inch)
    ...
    static let screen5_8Inch    = UIScreen.isEqual(UIScreen.Size.screen5_8Inch)
    
    static let screen7_9Inch    = UIScreen.isEqual(UIScreen.Size.screen7_9Inch)
    static let screen10_5Incn    = UIScreen.isEqual(UIScreen.Size.screen10_5Incn)
...
struct DeviceType {
    ...
    static let isIPhone8                        = UIDevice.iPhone8Series.contains(UIDevice.modelReadable())
    static let isIPhone8Plus                    = UIDevice.iPhone8PlusSeries.contains(UIDevice.modelReadable())
    static let isIPhoneX                        = UIDevice.iPhoneXSeries.contains(UIDevice.modelReadable())
...
struct iOSVersion {
    ...
    static let iOS11Earlier  = UIDevice.iOS.equalOrEarlier(UIDevice.iOS.Version.eleven)
    static let iOS11         = UIDevice.iOS.equal(UIDevice.iOS.Version.eleven)
    static let iOS11Later    = UIDevice.iOS.equalOrLater(UIDevice.iOS.Version.eleven)
}
